...
const populateBotResponse = async (userMessage) => {
    ...
    if (isFirstMessage) {
        response = { botResponse: "Halo, saya adalah Chatbot asisten yang siap membantumu terkait dangerous good, tolong upload PDF MSDS" };
        uploadButtonHtml = `
    ...
    if (isFirstMessage) {
        ...
        $("#file-upload").on("change", async function () {
            ...
            // Setelah upload dan proses selesai, aktifkan tombol Send dan input text
            document.getElementById('send-button').disabled = false;
...
$(document).ready(function () {
    ...
    // Start the chat with send button and text input disabled
    document.getElementById('send-button').disabled = true;
    document.getElementById('message-input').disabled = true;
    document.getElementById('message-input').placeholder = "Silahkan upload file terlebih dahulu";
    ...
    $("#reset-button").click(async function () {
        ...
        // Disable input text and change placeholder after reset
        document.getElementById('send-button').disabled = true;
        document.getElementById('message-input').disabled = true;
        document.getElementById('message-input').placeholder = "Silahkan upload file terlebih dahulu";
